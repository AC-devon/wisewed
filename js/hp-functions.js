...
$("#have-acc-login,.enter").click(function() {
    $("#login-content").fadeOut();
    $("#regform").fadeIn();
});
...
function register(fullName,email,userImage,displayName,area,phone) {
  ...
  dataBase.ref('users/' + userId).set({
    ...
    WifeName: '',
    HusbandPhone: '',
    WifePhone: phone === undefined ? "" : phone,
    HusbandArea: '',
    WifeArea: '',
    Guest:'',
    Date: '',    
  ...
  dataBase.ref('users/' + userId + '/CurrentWed').set({
    hall: '',
    light: '',
    design: '',
    photography: '',
